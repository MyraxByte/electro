...
export function createNodeConfig(opts: NodeConfigOptions): InlineConfig {
    ...
    const resolveConditions = opts.scope === "preload" ? ["node", moduleCondition, "default"] : ["node", moduleCondition];
    ...
    const config: InlineConfig = {
        configFile: false,
        root: opts.root,
        plugins: [importMetaPlugin(), ...(opts.plugins ?? []), cjsExternalInteropPlugin(opts.cjsInteropDeps ?? []), esmShimPlugin()],
