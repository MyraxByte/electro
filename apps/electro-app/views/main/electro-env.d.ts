...
declare module "@electro/renderer" {
    interface BridgeQueries {
        ...
        "notes:getNote": import("@electro/renderer").BridgeContractEntry<_BridgeInputFromMethod<typeof import("../../runtime/src/modules/notes/notes.service").NotesService, "getNote">, _BridgeOutputFromMethod<typeof import("../../runtime/src/modules/notes/notes.service").NotesService, "getNote">>;
