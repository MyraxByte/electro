...
hero:
    ...
    actions:
        - theme: brand
          text: Get Started
          link: /versions/v1.0/guide/getting-started
        - theme: alt
          text: GitHub
