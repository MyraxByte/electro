...
This mapping is generated by `electro generate`. See [Code Generation](./codegen.md).
...
After running `electro generate`, Electro writes package-local `electro-env.d.ts` files that augment `@electro/renderer`. The generated interface looks like:
